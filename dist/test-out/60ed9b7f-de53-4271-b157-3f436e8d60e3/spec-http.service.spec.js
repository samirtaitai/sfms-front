...
// src/app/core/http.service.spec.ts
init_zone_testing();
init_testing();
...
var HttpClientTestingBackend = class _HttpClientTestingBackend {
  ...
  static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.1.1", ngImport: core_exports, type: _HttpClientTestingBackend, deps: [], target: FactoryTarget.Injectable });
  static \u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.1.1", ngImport: core_exports, type: _HttpClientTestingBackend });
};
\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.1.1", ngImport: core_exports, type: HttpClientTestingBackend, decorators: [{
  type: Injectable
}] });
...
var HttpClientTestingModule = class _HttpClientTestingModule {
  static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.1.1", ngImport: core_exports, type: _HttpClientTestingModule, deps: [], target: FactoryTarget.NgModule });
  static \u0275mod = \u0275\u0275ngDeclareNgModule({ minVersion: "14.0.0", version: "20.1.1", ngImport: core_exports, type: _HttpClientTestingModule, imports: [HttpClientModule] });
  static \u0275inj = \u0275\u0275ngDeclareInjector({ minVersion: "12.0.0", version: "20.1.1", ngImport: core_exports, type: _HttpClientTestingModule, providers: [provideHttpClientTesting()], imports: [HttpClientModule] });
};
\u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.1.1", ngImport: core_exports, type: HttpClientTestingModule, decorators: [{
  type: NgModule,
  args: [{
...
var HttpService = class HttpService2 {
  ...
  handleError(error) {
    ...
    return throwError(() => new Error("Ocurri\xF3 un error en la solicitud HTTP."));
  }
...
describe("HttpService", () => {
  ...
  it("deber\xEDa hacer una petici\xF3n GET correctamente", () => {
    const mockData = { name: "Samir" };
    service.get("https://api.example.com/user").subscribe((data) => {
  ...
  it("deber\xEDa manejar errores correctamente", () => {
    service.get("https://api.example.com/error").subscribe({
      next: () => fail("La petici\xF3n deber\xEDa fallar"),
      error: (error) => {
        expect(error.message).toContain("Ocurri\xF3 un error");
      }
    });
...
@angular/common/fesm2022/http/testing.mjs:
   ...
   *)
*/
//# sourceMappingURL=spec-http.service.spec.js.map

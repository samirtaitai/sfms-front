  ...
  "src/app/pages/login-page/login-page.ts"() {
    ...
    LoginPage = class LoginPage2 {
      ...
      constructor(authService) {
        ...
        this.authService.subscribeToLoading().subscribe((loging) => {
          this.loading = loging;
...
// src/app/pages/login-page/login-page.spec.ts
var require_login_page_spec = __commonJS({
  "src/app/pages/login-page/login-page.spec.ts"(exports) {
    init_testing();
    init_login_page3();
    describe("LoginPage", () => {
      let component;

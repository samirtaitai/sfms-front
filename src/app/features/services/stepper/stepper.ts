...
import { OesI, OesService } from '../../organization-entity/oes.service';
import { ApplicationI, ApplicationService } from '../../application/application.service';
import { ServiceEntitiesForm } from "../../../components/service-entities-form/service-entities-form";
import { LoadedElementsComponent } from "../../../components/loaded-elements/loaded-elements";
import { RolesConfigTable } from "../../../components/roles-config-table/roles-config-table";
...
export class Stepper implements OnInit {
  ...
  onboardApplication() {
    ...
    this.servicesSrv.createService(consumer).subscribe({
      next: (response) => {
  ...
  navigateToAdmin() {
    this.router.navigate([INTERNAL_ROUTES.ADMIN])
  }
